...
<body>
    ...
    $query = "SELECT * FROM producto WHERE idProducto='$cod_editar'";
    ...
    $categoria = "SELECT nombre FROM categoria WHERE idCategoria=$cat";
    $result = mysqli_query($conn, $categoria);

    $nombreCat = mysqli_fetch_assoc($result);
                    ...
                    <form action="editarProductosql.php" method="POST" class="text-start row" enctype="multipart/form-data"> 
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nom" placeholder="nombre" value="<?php echo $row['nombre'] ?>" required>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 mb-4">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="stock" placeholder="Stock" value="<?php echo $row['stock'] ?>" required>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 mb-4">
