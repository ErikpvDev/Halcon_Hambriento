...
<body>
    ...
    $query = "SELECT * FROM categoria WHERE idCategoria='$cod_editar'";
        ...
        <div class="container">
            <div class="row mt-5 justify-content-center">
                <div class="col-8 mt-5 contenedor text-center">
                    <h1 class="mt-3 mb-3"><?php echo $cat ?></h1>
                    <form action="editarCategoriasql.php" method="POST" class="text-start row">
